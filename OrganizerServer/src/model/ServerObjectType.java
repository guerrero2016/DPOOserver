...
public enum ServerObjectType {
    ...
    SET_TASK(7), DELETE_TASK(8), INVITE_USER(9), DELETE_USER(10), EXIT_PROJECT(11), LOGOUT(12), SET_TAG(13), DELETE_TAG(14),
    SET_MEMBER(15), DELETE_MEMEBER(16), AUTH(17), SWAP_CATEGORY(18), SWAP_TASK(19), DELETE_PROJECT(20),
    TASK_DONE(21), TASK_NOT_DONE(22), GET_PROJECT_LIST(23), JOIN_PROJECT(24);
